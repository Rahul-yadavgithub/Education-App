...
import GenerationModal from "./PaperGeneration/GenerationModal"; // ✅ modal
...
export default function PaperGeneratorSection() {
  ...
  return (
    <>
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <button
              ...
              className="inline-flex items-center gap-2 px-5 py-2 rounded-xl bg-gradient-to-r from-purple-600 to-teal-400 text-white font-semibold shadow-md hover:scale-[1.01] transition"
            >
      ...
      {/* ✅ Generation Modal */}
      <GenerationModal isOpen={showModal} onClose={handleCloseModal} />
    </>
  );
}

/* Tab-style Card Placeholder */

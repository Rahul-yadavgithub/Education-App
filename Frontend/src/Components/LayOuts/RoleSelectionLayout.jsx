// src/Components/LayOuts/RoleSelectionLayout.jsx
...
const RoleSelectionLayout = () => {
  ...
  return (
    <div className="min-h-screen relative">
      ...
      <div className="relative min-h-screen bg-gradient-to-br from-gray-100 to-gray-200 flex flex-col items-center justify-center p-6">
        <motion.h1
